...
(function installDashboardIntegration(){
  ...
  style.textContent = `
    ...
    #page-dashboard,#page-dashboard *{letter-spacing:0!important}#page-dashboard .text-slate-400,#page-dashboard .text-slate-500,#page-dashboard .text-slate-600,#page-dashboard .muted,#page-dashboard .subtle{color:#334155!important}#page-dashboard .bento-hd,#page-dashboard h2,#page-dashboard h3,#page-dashboard h4{color:#0f172a!important}#page-dashboard .text-xs,#page-dashboard [class*="text-[10px]"],#page-dashboard [class*="text-[11px]"]{font-size:12.5px!important;line-height:1.45!important}#page-dashboard .text-[10px],#page-dashboard .text-[11px]{font-size:12.5px!important}
    #page-dashboard .card,#page-dashboard .bento,#page-dashboard .period-kpi,#page-dashboard .task-card{border-color:rgba(148,163,184,.42)!important;box-shadow:0 12px 30px rgba(15,23,42,.085)!important}#page-dashboard .card .card,#page-dashboard .bento .card,#page-dashboard .task-card .card{box-shadow:none!important;border-color:rgba(148,163,184,.28)!important;background:rgba(255,255,255,.68)!important}
    #page-dashboard .metric-fill,#page-dashboard .progress-fill,#page-dashboard .bar-fill,#page-dashboard .unit-bar-fill,#page-dashboard [class*="progress"] [style*="width"],#page-dashboard [class*="bar"] [style*="width"]{transition:opacity .18s ease,transform .18s ease,background-color .18s ease!important}
    #page-dashboard .ai-glow,#page-dashboard .glow,#page-dashboard [class*="glow"]{box-shadow:0 8px 22px rgba(15,23,42,.1)!important}
  ...
  function patchImpeccablePolish(){const dashboard=document.getElementById('page-dashboard');if(!dashboard) return false;dashboard.querySelectorAll('h4').forEach((heading)=>{if(heading.dataset.ubktHeadingFixed) return;if(!heading.closest('.task-card,.card,.bento')) return;const h3=document.createElement('h3');Array.from(heading.attributes).forEach((attr)=>h3.setAttribute(attr.name,attr.value));h3.innerHTML=heading.innerHTML;h3.dataset.ubktHeadingFixed='1';heading.replaceWith(h3);});dashboard.querySelectorAll('[style*="transition"][style*="max-height"],[style*="transition"][style*="width"]').forEach((el)=>{el.style.transition='opacity .18s ease, transform .18s ease, background-color .18s ease';});return true;}
